...
build_dll:
	...
	$(LD) $(LFLAGS) $(DLL_OBJS) $(FI_OBJS) \
          $(SDK_COFF_X64)fi$(L)FreeImage.lib $(LFLAGS_1)
	$(SP) $(SFLAGS)
	...
	$(LD) $(LFLAGS) $(DLL_OBJS) $(DEVIL_OBJS) \
          $(SDK_COFF_X64)devil$(L)ResIL.lib $(LFLAGS_1)
	$(SP) $(SFLAGS)
	mmvv CrH_FMTZ.dll zDevIL.dll
	$(LD) $(LFLAGS) $(DLL_OBJS) $(FMOD_OBJS) \
          $(SDK_COFF_X64)fmod$(L)fmodex64_vc.lib $(LFLAGS_1)
	$(SP) $(SFLAGS)
	mmvv CrH_FMTZ.dll zFMOD.dll
	$(LD) $(LFLAGS) $(DLL_OBJS) $(RAR_OBJS) \
          $(SDK_COFF_X64)unrar$(L)unrar64.lib $(LFLAGS_1)
	$(SP) $(SFLAGS)
