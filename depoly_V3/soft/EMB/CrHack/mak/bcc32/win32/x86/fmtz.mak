...
build_dll:
    ...
    $(LD) $(LFLAGS) -L$(SDK_OMF_X86)fmod \
                    $(DLL_OBJS) $(FMOD_OBJS) $(LFLAGS_1)
    move CrH_FMTZ.dll zFMOD.dll
    $(LD) $(LFLAGS) -L$(SDK_OMF_X86)unrar \
                    $(DLL_OBJS) $(RAR_OBJS) $(LFLAGS_1)
    ...
    $(LD) $(LFLAGS) $(DLL_OBJS) $(OBJS) $(LFLAGS_1) .$(L)fmtz.res
    del *.obj /Q
    del *.res /Q
