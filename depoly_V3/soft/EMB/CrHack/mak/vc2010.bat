...
echo C_ADDONS=/D "WIN32" /D "_WIN32" /I "..\inc\l3rd\dxsdk" /wd4819 /Oy- /WX- /Gm- /arch:SSE >> conf.inc
...
move *.dll ..\bin\vc2010_win32_x86
move *.lib ..\bin\vc2010_win32_x86
del conf.inc

echo R_ADDONS= > conf.inc
echo C_ADDONS=/D "WIN64" /D "_WIN64" /I "..\inc\l3rd\dxsdk" /wd4819 /Oy- /WX- /Gm- >> conf.inc
echo A_ADDONS= >> conf.inc
...
move *.dll ..\bin\vc2010_win32_x64
move *.lib ..\bin\vc2010_win32_x64
del conf.inc
