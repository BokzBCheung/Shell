@set VSINSTALLDIR=%DEV_ROOT%\Microsoft Visual Studio 8
@set VCINSTALLDIR=%DEV_ROOT%\Microsoft Visual Studio 8\VC
...
@echo Setting environment for using Microsoft Visual Studio 2005 ARMv4 cross tools.
