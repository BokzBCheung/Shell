...
void_t  so_gfx2_init (void_t) __attribute__((constructor));
void_t  so_gfx2_init (void_t)
{
}
void_t  so_gfx2_fini (void_t) __attribute__((destructor));
void_t  so_gfx2_fini (void_t)
{
}
#endif  /* _CR_OS_MSWIN_ */
