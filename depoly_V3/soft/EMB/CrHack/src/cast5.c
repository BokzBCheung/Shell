...
static const int32u _rom_ s_s5[256] =
{
...
static const int32u _rom_ s_s6[256] =
{
...
static const int32u _rom_ s_s7[256] =
{
...
static const int32u _rom_ s_b8[256] =
{
...
{
    z[0] = x[0] ^ s_s5[xi(13)] ^ s_s6[xi(15)] ^ s_s7[xi(12)] ^
                  s_b8[xi(14)] ^ s_s7[xi( 8)];
    z[1] = x[2] ^ s_s5[zi( 0)] ^ s_s6[zi( 2)] ^ s_s7[zi( 1)] ^
                  s_b8[zi( 3)] ^ s_b8[xi(10)];
    z[2] = x[3] ^ s_s5[zi( 7)] ^ s_s6[zi( 6)] ^ s_s7[zi( 5)] ^
                  s_b8[zi( 4)] ^ s_s5[xi( 9)];
    z[3] = x[1] ^ s_s5[zi(10)] ^ s_s6[zi( 9)] ^ s_s7[zi(11)] ^
                  s_b8[zi( 8)] ^ s_s6[xi(11)];

    k[0] = s_s5[zi( 8)] ^ s_s6[zi( 9)] ^ s_s7[zi(7)] ^ s_b8[zi(6)] ^
           s_s5[zi( 2)];
    k[1] = s_s5[zi(10)] ^ s_s6[zi(11)] ^ s_s7[zi(5)] ^ s_b8[zi(4)] ^
           s_s6[zi( 6)];
    k[2] = s_s5[zi(12)] ^ s_s6[zi(13)] ^ s_s7[zi(3)] ^ s_b8[zi(2)] ^
           s_s7[zi( 9)];
    k[3] = s_s5[zi(14)] ^ s_s6[zi(15)] ^ s_s7[zi(1)] ^ s_b8[zi(0)] ^
           s_b8[zi(12)];

    x[0] = z[2] ^ s_s5[zi( 5)] ^ s_s6[zi(7)] ^ s_s7[zi( 4)] ^
                  s_b8[zi( 6)] ^ s_s7[zi(0)];
    x[1] = z[0] ^ s_s5[xi( 0)] ^ s_s6[xi(2)] ^ s_s7[xi( 1)] ^
                  s_b8[xi( 3)] ^ s_b8[zi(2)];
    x[2] = z[1] ^ s_s5[xi( 7)] ^ s_s6[xi(6)] ^ s_s7[xi( 5)] ^
                  s_b8[xi( 4)] ^ s_s5[zi(1)];
    x[3] = z[3] ^ s_s5[xi(10)] ^ s_s6[xi(9)] ^ s_s7[xi(11)] ^
                  s_b8[xi( 8)] ^ s_s6[zi(3)];

    k[4] = s_s5[xi( 3)] ^ s_s6[xi(2)] ^ s_s7[xi(12)] ^ s_b8[xi(13)] ^
           s_s5[xi( 8)];
    k[5] = s_s5[xi( 1)] ^ s_s6[xi(0)] ^ s_s7[xi(14)] ^ s_b8[xi(15)] ^
           s_s6[xi(13)];
    k[6] = s_s5[xi( 7)] ^ s_s6[xi(6)] ^ s_s7[xi( 8)] ^ s_b8[xi( 9)] ^
           s_s7[xi( 3)];
    k[7] = s_s5[xi( 5)] ^ s_s6[xi(4)] ^ s_s7[xi(10)] ^ s_b8[xi(11)] ^
           s_b8[xi(7)];
    ...
    k[ 8] = s_s5[zi( 3)] ^ s_s6[zi(2)] ^ s_s7[zi(12)] ^ s_b8[zi(13)] ^
            s_s5[zi( 9)];
    k[ 9] = s_s5[zi( 1)] ^ s_s6[zi(0)] ^ s_s7[zi(14)] ^ s_b8[zi(15)] ^
            s_s6[zi(12)];
    k[10] = s_s5[zi( 7)] ^ s_s6[zi(6)] ^ s_s7[zi( 8)] ^ s_b8[zi( 9)] ^
            s_s7[zi( 2)];
    k[11] = s_s5[zi( 5)] ^ s_s6[zi(4)] ^ s_s7[zi(10)] ^ s_b8[zi(11)] ^
            s_b8[zi( 6)];
    ...
    k[12] = s_s5[xi( 8)] ^ s_s6[xi( 9)] ^ s_s7[xi(7)] ^ s_b8[xi(6)] ^
            s_s5[xi( 3)];
    k[13] = s_s5[xi(10)] ^ s_s6[xi(11)] ^ s_s7[xi(5)] ^ s_b8[xi(4)] ^
            s_s6[xi( 7)];
    k[14] = s_s5[xi(12)] ^ s_s6[xi(13)] ^ s_s7[xi(3)] ^ s_b8[xi(2)] ^
            s_s7[xi( 8)];
    k[15] = s_s5[xi(14)] ^ s_s6[xi(15)] ^ s_s7[xi(1)] ^ s_b8[xi(0)] ^
            s_b8[xi(13)];
}
#undef  xi
#undef  zi
    ...
    )
{
    uint_t  idx;
    int32u  xx[4], zz[4];
    int32u  kk[16], p_key[4];

    if (keylen > 16)
        keylen = 16;
    mem_set(p_key, 0x0, 16);
    mem_cpy(p_key, key, keylen);
    xx[0] = DWORD_BE(p_key[0]);
    xx[1] = DWORD_BE(p_key[1]);
    xx[2] = DWORD_BE(p_key[2]);
    xx[3] = DWORD_BE(p_key[3]);
    ctx->round = (keylen <= 10) ? 1 : 0;

    key_schedule(xx, zz, kk);
    for (idx = 0; idx < 16; idx++)
        ctx->km[idx] = (int32u)(kk[idx]);
    key_schedule(xx, zz, kk);
    for (idx = 0; idx < 16; idx++)
        ctx->kr[idx] = (byte_t)(kk[idx] & 0x1F);
}
...
CR_API void_t
crypto_cast5_enc (
  __CR_IN__ const sCAST5*   ctx,
  __CR_OT__ int32u          dst[2],
  __CR_IN__ const int32u    src[2]
    )
{
    byte_t  *kr;
    int32u  *km, I;
    ...
    if (!(ctx->round))
    {
        tt = ll; ll = rr; rr = tt ^ CAST5_F1(rr, km[ 0], kr[ 0]);
        tt = ll; ll = rr; rr = tt ^ CAST5_F2(rr, km[ 1], kr[ 1]);
        tt = ll; ll = rr; rr = tt ^ CAST5_F3(rr, km[ 2], kr[ 2]);
        tt = ll; ll = rr; rr = tt ^ CAST5_F1(rr, km[ 3], kr[ 3]);
        tt = ll; ll = rr; rr = tt ^ CAST5_F2(rr, km[ 4], kr[ 4]);
        tt = ll; ll = rr; rr = tt ^ CAST5_F3(rr, km[ 5], kr[ 5]);
        tt = ll; ll = rr; rr = tt ^ CAST5_F1(rr, km[ 6], kr[ 6]);
        tt = ll; ll = rr; rr = tt ^ CAST5_F2(rr, km[ 7], kr[ 7]);
        tt = ll; ll = rr; rr = tt ^ CAST5_F3(rr, km[ 8], kr[ 8]);
        tt = ll; ll = rr; rr = tt ^ CAST5_F1(rr, km[ 9], kr[ 9]);
        tt = ll; ll = rr; rr = tt ^ CAST5_F2(rr, km[10], kr[10]);
        tt = ll; ll = rr; rr = tt ^ CAST5_F3(rr, km[11], kr[11]);
        tt = ll; ll = rr; rr = tt ^ CAST5_F1(rr, km[12], kr[12]);
        tt = ll; ll = rr; rr = tt ^ CAST5_F2(rr, km[13], kr[13]);
        tt = ll; ll = rr; rr = tt ^ CAST5_F3(rr, km[14], kr[14]);
        tt = ll; ll = rr; rr = tt ^ CAST5_F1(rr, km[15], kr[15]);
    }
    else
    {
        tt = ll; ll = rr; rr = tt ^ CAST5_F1(rr, km[ 0], kr[ 0]);
